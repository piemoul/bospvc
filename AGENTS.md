...
- After modifying code files in this session, run `graphify hook-rebuild` to keep the graph current; use the full Graphify skill when documentation semantics also changed
